...
export type BarDatum = {
    ...
    value: number;
    current?: boolean;
    /** Fuller name for the tooltip, e.g. "Agu 2026". Falls back to `label`. */
    title?: string;
};
 ...
 * exact value. Set `showValues` to print a compact label above each bar, and
 * `onSelect` to make the bars clickable (e.g. to jump to that month).
 */
